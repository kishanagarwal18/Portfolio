...
//             I’m open to collaboration on exciting projects and ideas — feel free to reach out and connect with me!
//           </p>

//           <div className="rounded-2xl overflow-hidden shadow-xl border border-dark-400">
//             <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.085819004227!2d77.56140371571726!3d13.030206764418166!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae17df0d1150df%3A0xf726a51b4e49b0aa!2sVisitors%20Comfort!5e0!3m2!1sen!2sin!4v1747499721439!5m2!1sen!2sin"
...
//           <h2 className="text-3xl font-semibold text-dark-900 dark:text-light-100 mb-4">
//             Contact Form
//           </h2>

//           <div className="bg-light-100 dark:bg-dark-200 p-8 rounded-lg shadow-lg">
//             <form onSubmit={handleSubmit} className="space-y-6">
//               <div>
//                 <label htmlFor="name" className="block text-sm font-medium text-dark-900 dark:text-light-100 mb-2">
//                   Your Name
//                 </label>
//                 <input
//                   type="text"
...
//                   required
//                   className="w-full px-4 py-2 rounded-lg bg-light-200 dark:bg-dark-300 text-dark-900 dark:text-light-100 border border-light-300 dark:border-dark-400 focus:outline-none focus:ring-2 focus:ring-gold-500"
//                 />
//               </div>

//               <div>
//                 <label htmlFor="email" className="block text-sm font-medium text-dark-900 dark:text-light-100 mb-2">
//                   Your Email
//                 </label>
//                 <input
//                   type="email"
...
//               <div>
//                 <label htmlFor="subject" className="block text-sm font-medium text-dark-900 dark:text-light-100 mb-2">
//                   Subject
//                 </label>
//                 <input
//                   type="text"
...
//               <div>
//                 <label htmlFor="message" className="block text-sm font-medium text-dark-900 dark:text-light-100 mb-2">
//                   Message
//                 </label>
//                 <textarea
//                   id="message"
...
//                 className="w-full px-6 py-3 bg-gold-500 text-black rounded-lg font-medium flex items-center justify-center gap-2 hover:bg-gold-400 transition-colors duration-300 disabled:opacity-50"
//               >
//                 {status === 'sending' ? (
//                   'Sending...'
//                 ) : (
